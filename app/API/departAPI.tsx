...
const API_URL = 'http://localhost:8080/user/sonatrachapi/depart';
...
export const confirmDepart = (id) => {
    return axios.get(`${API_URL}/confirm/${id}`)
        .then(response => response.data)
        .catch(handleError);
};

export const inconfirmDepart = (id) => {
    return axios.get(`${API_URL}/inconfirm/${id}`)
        .then(response => response.data)
        .catch(handleError);
};
